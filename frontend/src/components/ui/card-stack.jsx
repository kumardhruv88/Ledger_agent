              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    ...
                    "will-change-transform select-none bg-aivora-card",
                    isActive
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-[#0a0a0a] text-sm text-white/50">
            No image
          </div>
        )}
      </div>
